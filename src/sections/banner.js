...
import BannerImage from 'assets/bitcoin-phone.png';
const BANNER_DATA = {
  title: 'Welcome to KNL TECHNICAL PIPS',
  text:
    'KNL Technical Pips was founded by 3 traders and has been operational since 2019. It was created to help newbies get into the game of financial markets. As an academy we aim to reach as many Novice, Intermediate  and even Professional traders to treat our services as platform to uplift and inspire one another.',
  button: {
    link: '#',
    label: 'Get Token',
  },
